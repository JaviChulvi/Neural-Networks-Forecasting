...
- Media MAE test **mejor global**     : `0.005346`
- Media MAE test **regresión lineal** : `0.005668`
- Media Δ vs LR : `-0.000322` (-5.68%)
...
| 10 | 90 | **CNN** | CNN_Deep_Conv1D | `0.001235` | `0.001282` | `-3.66%` ↓ |
...
| 30 | 90 | **CNN** | CNN_Deep_Conv1D | `0.001230` | `0.001351` | `-9.00%` ↓ |
...
| **out=90** | `0.001262` | `0.001235` | `0.001230` | `0.001264` |
...
| 10 | 1 | `0.012270` | `0.012239` | **`0.012234`** | `0.012244` | **RNN** |
| 10 | 5 | `0.005609` | **`0.005575`** | `0.005582` | `0.005604` | **CNN** |
| 10 | 30 | **`0.002319`** | `0.002321` | `0.002334` | `0.002334` | **MLP** |
| 10 | 90 | `0.001268` | **`0.001235`** | `0.001276` | `0.001272` | **CNN** |
| 30 | 1 | `0.012282` | `0.012243` | **`0.012240`** | `0.012286` | **RNN** |
| 30 | 5 | `0.005611` | **`0.005577`** | `0.005597` | `0.005598` | **CNN** |
| 30 | 30 | `0.002360` | **`0.002319`** | `0.002340` | `0.002340` | **CNN** |
| 30 | 90 | `0.001285` | **`0.001230`** | `0.001269` | `0.001346` | **CNN** |
| 90 | 1 | `0.012293` | `0.012260` | **`0.012256`** | `0.012273` | **RNN** |
...
| **out=90** | `-0.000009` ↓ | `-0.000047` ↓ | `-0.000122` ↓ | `-0.000254` ↓ |
