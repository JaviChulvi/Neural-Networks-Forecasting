...
DROPOUT     = 0.2
LR          = 1e-4
BATCH_SIZE  = int(os.getenv("GRU_BATCH_SIZE", "128"))
EPOCHS      = int(os.getenv("GRU_EPOCHS", "200"))
PATIENCE    = 10
...
model_path = model_dir / f"rnn_gru_input{INPUT_W}_output{OUTPUT_W}_model.keras"
